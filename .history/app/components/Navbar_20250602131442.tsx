          ...
          <div className="relative bg-white dark:bg-gray-900 shadow-xl transform transition-all duration-300 ease-in-out max-w-xs w-full h-full">
            <div className="px-5 pt-5 pb-6">
              ...
              <div className="mt-8 space-y-1">
                <Link href="/" className="block px-3 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-gray-100 dark:hover:bg-gray-800 text-base font-medium transition-colors">
                  Accueil
                </Link>
                <Link href="/services" className="block px-3 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-gray-100 dark:hover:bg-gray-800 text-base font-medium transition-colors">
                  Services
                </Link>
                <Link href="/about" className="block px-3 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-gray-100 dark:hover:bg-gray-800 text-base font-medium transition-colors">
                  À propos
                </Link>
                <Link href="/contact" className="block px-3 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-gray-100 dark:hover:bg-gray-800 text-base font-medium transition-colors">
                  Contact
                </Link>
              </div>
            </div>
