...
const technologies = [
  ...
  { name: 'Next.js', icon: '/tech/next.jpg' },
  { name: 'Node.js', icon: '/tech/node.jpg' },
  { name: 'Flutter', icon: '/tech/flutter.jpg' },
  { name: 'React Native', icon: '/tech/native.jpg' },
  { name: 'Swift', icon: '/tech/swift.jpg' },
];
